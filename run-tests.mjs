...
const p4 = await Project.create({ client: { name: "Ongoing Client", email: "og@test.com" }, projectName: "Ongoing Project", priority: "medium", status: "ongoing", assignedEditor: editor._id, payment: { amount: 3000, clientAmount: 3000, editorAmount: 1000 }, createdBy: admin._id, activityTimeline: [
