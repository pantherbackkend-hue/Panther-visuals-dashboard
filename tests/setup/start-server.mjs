...
await Project.create({ client: { name: "Test Client Inc" }, clientRef: client._id, projectName: "Standard Project", driveLink: "https://drive.google.com/standard", priority: "medium", payment: { amount: 5000, clientAmount: 5000 }, createdBy: admin._id, activityTimeline: [tl("Project Created", admin, "Test Admin", "", "pending_assignment")] });
...
await Project.create({ client: { name: "Direct Client" }, projectName: "Direct Assign Project", driveLink: "https://drive.google.com/direct", priority: "urgent", assignedEditor: editor._id, ownerAssignment: "direct", payment: { amount: 8000, clientAmount: 8000, editorAmount: 3000 }, createdBy: owner._id, activityTimeline: [tl("Project Created", owner, "Test Owner", "", "pending_assignment"), tl("Assigned", owner, "Test Owner", "pending_assignment", "assigned")] });
