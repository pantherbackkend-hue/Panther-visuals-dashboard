...
await makeProject({ client: { name: "Test Client Inc" }, clientRef: client._id, projectName: "Standard Project", assetsFolderLink: "https://drive.google.com/standard", projectFilesLink: "https://drive.google.com/standard-files", priority: "medium", payment: { amount: 5000, clientAmount: 5000 }, createdBy: admin._id, activityTimeline: [T("Project Created", admin, "Test Admin", "", "pending_assignment")] });
